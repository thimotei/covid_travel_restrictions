...
september_travel_data %>% 
    dplyr::summarise(sf_mean_september  = mean(scaling_factor),
                     sf_lower_september = min(scaling_factor),
                     sf_upper_september = max(scaling_factor))
...
imported_cases_and_incidence_together_labels <- imported_cases_and_incidence_together_labels_september %>%
    dplyr::left_join(imported_cases_and_incidence_together_labels_may) %>%
