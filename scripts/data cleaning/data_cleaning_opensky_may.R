...
open_sky_may_2019   <- readr::read_csv("data/raw_data/opensky_may_2019.csv.gz")
open_sky_may_2020   <- readr::read_csv("data/raw_data/opensky_may_2020.csv.gz")
...
write.csv(total_flights_may_2019_2020, "data/flight_reduction_scaling_factors_may.csv")
